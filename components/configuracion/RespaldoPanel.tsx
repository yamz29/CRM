        ...
        {loading ? (
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-border">
              {backups.map((b) => (
                <tr key={b.filename} className="hover:bg-muted">
                  <td className="px-5 py-3">
                    <span className="text-sm font-mono text-foreground">{b.filename}</span>
                  </td>
      ...
      <div className="bg-card border border-border rounded-xl overflow-hidden">
        <div className="px-5 py-3 border-b border-border">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Reemplaza la base de datos actual con un archivo <code className="bg-muted px-1 rounded">.db</code> o <code className="bg-muted px-1 rounded">.sqlite</code> externo.
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 flex-wrap">
                <input
                  ...
                  className="text-sm text-muted-foreground file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:text-xs file:font-semibold file:bg-muted file:text-foreground hover:file:bg-muted cursor-pointer"
                />
                <Button
                  variant="secondary"
                  size="sm"
                ...
                {imp.step !== 'idle' && (
                  <button onClick={resetImport} className="text-xs text-muted-foreground hover:text-muted-foreground underline">
                    Cancelar
                  </button>
                )}
              </div>
