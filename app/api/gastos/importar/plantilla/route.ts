...
export const GET = withPermiso('gastos', 'ver', async (_req: NextRequest) => {
  ...
  const instrRows = [
    ...
    ['proyecto_codigo', 'Código del proyecto (R-0042). Si lo dejas vacío, queda sin proyecto.'],
    ...
    ['2.', 'Si proyecto_codigo no se encuentra en el sistema, la fila queda como ERROR en el preview.'],
