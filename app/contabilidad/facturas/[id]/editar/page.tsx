...
export default async function EditarFacturaPage({
  ...
  const facturaData = {
    ...
    tasaItbis: (factura as unknown as { tasaItbis?: number }).tasaItbis ?? 18,
    impuesto: factura.impuesto,
    propinaLegal: (factura as unknown as { propinaLegal?: number }).propinaLegal ?? 0,
    otrosImpuestos: (factura as unknown as { otrosImpuestos?: number }).otrosImpuestos ?? 0,
    total: factura.total,
